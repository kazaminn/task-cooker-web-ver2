...
const styles = tv({
  base: 'group dark:bg-hover box-border rounded-lg border border-main bg-surface px-3 py-1.5 font-sans text-xs text-body drop-shadow-lg will-change-transform dark:border-main/10',
  variants: {
    isEntering: {
